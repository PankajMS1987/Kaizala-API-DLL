namespace Microsoft.Kaizala.Util
{
    ...
    {
        public static string UNAUTHETICATED_ERROR_CODE_STRING = "Unauthenticated";
        public static string INVALID_PARAMETERS_STRING = "InvalidParameters";
        public static string INVALID_TOKEN_STRING = "InvalidToken";
